...
(function () {
    ...
    function addSpeedLabel() {
        ...
        speedLabel.style = 'position: absolute; top: 5px; left: 5px; z-index: 999; background: transparent; color: white; height: 20px; width: 100px;';
        ...
        if (document.querySelector(videoType.videoSelector))
            document.querySelector(videoType.videoSelector).prepend(speedLabel);
        else
    ...
    function registerWheelListener() {
        document.addEventListener('wheel', function (e) {
            if (e.ctrlKey) {
                ...
                if (e.deltaY > 0)
                    changeRate = -0.1;
                var nodes = Array.prototype.slice.call(document.querySelectorAll('video'), 0);
    ...
    setTimeout(function () {
        var nodes = Array.prototype.slice.call(document.querySelectorAll('.smartstart-thumb'), 0);
        console.log(nodes.length, ' thumbnails found');
        nodes.forEach(function (tu) { return tu.addEventListener('click', function (t) {
